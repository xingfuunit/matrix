...
class Multi_curl {
	...
	public function request($url, $method = 'GET', $post_data = null, $headers = null, $options = null) {
		$this->requests [] = new Multi_obj ( $url, $method, $post_data, $headers, $options );
		//		echo '111111';
		return TRUE;
	}
	/**
	...
	//	unset ( $this->size, $this->timeout, $this->callback, $this->options, $this->headers, $this->requests, $this->request_map, $this->errors );
		...
		$this->timeout = 10;
		$this->callback = null;
		$this->options = array (CURLOPT_SSL_VERIFYPEER => 0,CURLOPT_RETURNTRANSFER => 1,CURLOPT_CONNECTTIMEOUT => 30 );
		$this->headers = array ();
		$this->requests = array ();
		$this->request_map = array ();
		$this->errors = array ();
