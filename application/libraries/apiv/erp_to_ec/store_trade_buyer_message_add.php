...
class Store_trade_buyer_message_add {
    ...
    function _init() {
		...
		$response_data['memo'] = json_encode(array('op_time'=>$request_data['add_time'],'op_content'=>$request_data['message'],'op_name'=>$request_data['sender']));
		...
		$response_data['message'] = json_encode(array('op_time'=>$request_data['add_time'],'op_content'=>$request_data['message'],'op_name'=>$request_data['sender']));
		$response_data['method'] = 'b2c.order.leave_message';
